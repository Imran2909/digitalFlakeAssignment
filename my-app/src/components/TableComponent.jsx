...
const TableComponent = ({ data, onEdit, onDelete }) => {
    ...
    //                     <label htmlFor="name">Name</label> {/* Label for Name */}
    //                     <Input
    //                         id="name"
    //                         placeholder="Name"
    ...
    //                 <div className={styles.formGroup}>
    //                     <label htmlFor="state">State Name</label> {/* Label for State */}
    //                     <Input
    //                         id="state"
    //                         placeholder="State"
    ...
    //                 <div className={styles.formGroup}>
    //                     <label htmlFor="city">City Name</label> {/* Label for City */}
    //                     <Input
    //                         id="city"
    //                         placeholder="City"
    ...
    //                 <div className={styles.formGroup}>
    //                     <label htmlFor="status">Status</label> {/* Label for Status */}
    //                     <Select
    //                         id="status"
